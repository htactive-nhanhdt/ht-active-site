          ...
          <div className="call-to-action">
            <div className="row">
              <div className="col-md-8">
                              <h1 className="title text-center">{language==="en"?"More detail":"Tìm hiểu thêm"}</h1>
                <p className="text-center">
                  {language==="en"?`Go to ${rawData.card_title}`:`Truy cập vào ${rawData.card_title} để tìm hiểu thêm`}
                </p>
              </div>
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  >
                    {language==="en"?`Go to ${rawData.card_title}`:`Đến ${rawData.card_title}`}
                  </Link>
                </div>
              </div>
            </div>
