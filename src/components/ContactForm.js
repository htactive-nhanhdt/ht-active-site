...
const ContactForm = () => {
  ...
  return (
    <React.Fragment>
      <GoogleMap />
      <div className={`container ${scrollY > 182 ? "solveBlink" : ""} `}>
        <div>
          ...
          <div className="main col-sm-12 col-lg-8 col-lg-pull-4 ">
            <p>
              If you need anything from us, please don't hesitate to contact
              with us via bellow form. We will contact you as soon as possible.
            </p>
